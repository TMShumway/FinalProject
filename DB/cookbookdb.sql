...
START TRANSACTION;
USE `cookbookdb`;
INSERT INTO `recipe` (`id`, `name`, `description`, `date_created`, `user_id`, `published`, `recipe_step`) VALUES (1, 'Spaghetti', 'Easy weeknight friendly spaghetti and meat sauce that’s made completely from scratch', '2021-07-20T21:46:28', 1, 1, 'MAKE SAUCE\nHeat the oil in a large pot over medium-high heat (we use a Dutch oven). Add the meat and cook until browned, about 8 minutes. As the meat cooks, use a wooden spoon to break it up into smaller crumbles.\n\nAdd the onions and cook, stirring every once and a while, until softened, about 5 minutes.\n\nStir in the garlic, tomato paste, oregano, and red pepper flakes and cook, stirring continuously for about 1 minute.\n\nPour in the water and use a wooden spoon to scrape up any bits of meat or onion stuck to the bottom of the pot. Stir in the tomatoes, 3/4 teaspoon of salt, and a generous pinch of black pepper. Bring the sauce to a low simmer. Cook, uncovered, at a low simmer for 25 minutes. As it cooks, stir and taste the sauce a few times so you can adjust the seasoning accordingly (see notes for suggestions).\n\nCOOK SPAGHETTI\nAbout 15 minutes before the sauce is finished cooking, bring a large pot of salted water to the boil then cook pasta according to package directions, but check for doneness a minute or two before the suggested cooking time.\n\nTO FINISH\nTake the sauce off of the heat, and then stir in the basil. Toss in the cooked pasta, and then leave for a minute so that the pasta absorbs some of the sauce. Toss again, and then serve with parmesan sprinkled on top');
INSERT INTO `recipe` (`id`, `name`, `description`, `date_created`, `user_id`, `published`, `recipe_step`) VALUES (2, 'Pizza', 'This easy pizza dough recipe is great for beginners and produces a soft homemade pizza crust. Skip the pizza delivery because you only need 6 basic ingredients to begin!', '2021-07-20T21:46:28', 1, 1, '1. Preheat the oven to 450');
INSERT INTO `recipe` (`id`, `name`, `description`, `date_created`, `user_id`, `published`, `recipe_step`) VALUES (3, 'Ramen', 'EXTRA SPICY', '2021-07-20T21:46:28', 2, 1, '1. Boil water');
INSERT INTO `recipe` (`id`, `name`, `description`, `date_created`, `user_id`, `published`, `recipe_step`) VALUES (4, 'Gabagool', 'arrivederci', '2021-07-20T21:46:28', 3, 1, '1. Go to the store');
INSERT INTO `recipe` (`id`, `name`, `description`, `date_created`, `user_id`, `published`, `recipe_step`) VALUES (5, 'Birthday Cake', 'for the birthday', '2021-07-20T21:46:28', 4, 1, '1. Preheat the oven to 350');
INSERT INTO `recipe` (`id`, `name`, `description`, `date_created`, `user_id`, `published`, `recipe_step`) VALUES (6, 'Chicken Alfredo', 'Homemade alfredo on a weeknight? Yes! ', '2021-07-20T21:46:28', 2, 0, 'Boil a pot of water:\nPut a large pot of water on the stove and bring to a boil. Salt liberally.\n\nStart the sauce:\nAdd the butter, cream, salt, black pepper, and nutmeg to small or medium-sized sauce pan. Heat over medium-low heat until the butter melts and the mixture comes to a slight simmer. Then turn heat down to low and simmer the sauce, stirring regularly to prevent scalding, until the sauce thickens slightly, enough to coat the back of a spoon easily.');
INSERT INTO `recipe` (`id`, `name`, `description`, `date_created`, `user_id`, `published`, `recipe_step`) VALUES (7, 'Apple Pie', 'Grandma\'s recipe', '2021-07-20T21:46:28', 6, 0, '\nHeat oven to 425°F. Place 1 pie crust in ungreased 9-inch glass pie plate. Press firmly against side and bottom.');
INSERT INTO `recipe` (`id`, `name`, `description`, `date_created`, `user_id`, `published`, `recipe_step`) VALUES (8, 'Thai Curry', 'Hits the spot', '2021-07-20T21:46:28', 6, 1, 'Take out a large skillet and add to it the chicken, peppers, and onions. Drizzle with oil and turn the burner up to medium high heat. Stir everything around and cook for 6-8 minutes, cooking chicken just through. \n');
INSERT INTO `recipe` (`id`, `name`, `description`, `date_created`, `user_id`, `published`, `recipe_step`) VALUES (9, 'Fried Tofu', 'Best air-fried', '2021-07-20T21:46:28', 6, 0, 'Place two paper towels on a plate then place the entire block of tofu (drained from its packaging liquid) onto the plate. Place two more paper towels on top of the tofu then put a heavy item on top. Not TOO heavy that it would completely crush the tofu but heavy enough that it can squeeze out liquid.');
INSERT INTO `recipe` (`id`, `name`, `description`, `date_created`, `user_id`, `published`, `recipe_step`) VALUES (10, 'Guacamole', 'Dippin advised', '2021-07-20T21:46:28', 6, 1, 'In a medium bowl, mash together the avocados, lime juice, and salt. Mix in onion, cilantro, tomatoes, and garlic. Stir in cayenne pepper. Refrigerate 1 hour for best flavor, or serve immediately.');
INSERT INTO `recipe` (`id`, `name`, `description`, `date_created`, `user_id`, `published`, `recipe_step`) VALUES (11, 'Burrito', 'Chipotle secret', '2021-07-20T21:46:28', 1, 1, 'Make the Marinade: Place the onion, garlic, adobo sauce, olive oil, chile powder, cumin, oregano, salt, and pepper into a food processor or blender and process until smooth. Pour the marinade into a 1-cup measuring cup and add enough water to reach to 1 cup.');
